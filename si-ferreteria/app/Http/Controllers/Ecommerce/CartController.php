...
class CartController extends Controller
{
    ...
    public function applyDiscount(Request $request): RedirectResponse
    {
        ...
        session()->put('discount', [
            ...
            'amount' => $discount->toApplyDiscount($totals['subtotal'])
        ]);
        
        return redirect()->back()->with('success', '¡Cupón aplicado exitosamente! Descuento: $' . number_format($discount->toApplyDiscount($totals['subtotal']), 2));
    }
    ...
    protected function calculateTotal($cart): array
    {
        ...
        // Obtener descuento de sesión si existe
