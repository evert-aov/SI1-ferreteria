        ...
        <x-container-second-div>
            @if ($templates->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($templates as $template)
                        <div
                            class="bg-gradient-to-br from-gray-800/90 to-gray-900/90 rounded-lg p-5 border border-gray-700 hover:border-orange-600 transition-all duration-300 hover:shadow-lg hover:shadow-orange-600/20">
                            <!-- Template Header -->
                            ...
                            <div class="text-xs text-gray-500 mb-4 space-y-1 bg-gray-900/50 p-3 rounded">
                                <p>
                                    ...
                                    <span
                                        class="text-orange-400 font-medium">{{ $availableTables[$template->table_name] ?? $template->table_name }}</span>
                                </p>
                                <p>
            ...
            @else
                <div class="flex flex-col items-center justify-center py-16">
                    ...
                    <a href="{{ route('reports.users.index') }}"
                        class="px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-500 transition-all">
