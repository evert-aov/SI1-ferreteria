<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-100 mt-1">{{ $recentCashRegisters->where('closed_at', '!=', null)->whereDate('closed_at', today())->count() }}</p>
                </div>
        ...
        <div class="bg-gray-800 rounded-lg p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-400 text-sm">Total Cajas</p>
                    <p class="text-2xl font-bold text-gray-100 mt-1">{{ $recentCashRegisters->count() }}</p>
                </div>
