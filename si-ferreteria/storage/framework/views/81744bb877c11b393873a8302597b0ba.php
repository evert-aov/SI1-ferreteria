...
<?php endif; ?>
                            <span class="font-medium ms-3"><?php echo e(__('Inventory')); ?></span>
                        </div>
                        <?php if (isset($component)) { $__componentOriginal97c58ace6e19220496ecfc64841ce9f3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal97c58ace6e19220496ecfc64841ce9f3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.deployment','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            <span class="font-medium ms-3"><?php echo e(__('Purchase')); ?></span>
                        </div>
                        <?php if (isset($component)) { $__componentOriginal97c58ace6e19220496ecfc64841ce9f3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal97c58ace6e19220496ecfc64841ce9f3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.deployment','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
            ...
            <?php endif; ?>
             ...
             <?php if(auth()->user()->roles->whereIn('name', ['Administrador'])->count() > 0): ?>
                <li class="pt-4 mt-4">
                    <?php if (isset($component)) { $__componentOriginal631eeea8a2e0bc8a56d1953069a49272 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal631eeea8a2e0bc8a56d1953069a49272 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dividers','data' => ['title' => ''.e(__('Gestion de Ventas')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dividers'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Gestion de Ventas')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal631eeea8a2e0bc8a56d1953069a49272)): ?>
<?php $attributes = $__attributesOriginal631eeea8a2e0bc8a56d1953069a49272; ?>
...
<?php endif; ?>
                            <span class="font-medium ms-3"><?php echo e(__('Ventas')); ?></span>
                        </div>
                        <?php if (isset($component)) { $__componentOriginal97c58ace6e19220496ecfc64841ce9f3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal97c58ace6e19220496ecfc64841ce9f3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.deployment','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                <?php if (isset($component)) { $__componentOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['value' => 'Ventas','class' => 'ms-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['value' => 'Ventas','class' => 'ms-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581)): ?>
<?php $attributes = $__attributesOriginale3da9d84bb64e4bc2eeebaafabfb2581; ?>
...
<?php unset($__componentOriginal2a2c297b0745834982552d1caa4c788b); ?>
<?php endif; ?>
                            <span class="font-medium ms-3"><?php echo e(__('Reportes y Alertas')); ?></span>
                        </div>
                        <?php if (isset($component)) { $__componentOriginal97c58ace6e19220496ecfc64841ce9f3 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal97c58ace6e19220496ecfc64841ce9f3 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.deployment','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\Usuario\OneDrive\Desktop\Ferreteria\si1-ferreteria\si-ferreteria\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>