...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.header-base','data' => ['title' => ''.e(__('Category')).'','modeLive' => 'search','clickClearSearch' => 'clearSearch','clickOpenCreateModal' => 'openCreateModal','btnName' => ''.e(__('Create Category')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('Category')).'','mode-live' => 'search','click-clear-search' => 'clearSearch','click-open-create-modal' => 'openCreateModal','btn-name' => ''.e(__('Create Category')).'']); ?>
...
<?php /**PATH /mnt/disco_d/sexto_semestre/si1-ferreteria/si-ferreteria/resources/views/livewire/category/components/header-product.blade.php ENDPATH**/ ?>