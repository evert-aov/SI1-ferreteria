        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo e(route('catalog.index')); ?>">
                ...
                <ul class="navbar-nav">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <a class="btn btn-dashboard btn-sm" href="<?php echo e(route('dashboard')); ?>">
                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item">
                            <a class="btn btn-auth btn-sm" href="<?php echo e(route('register')); ?>">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 text-md-end">
                    ...
                    <p class="mb-0 text">
                        &copy; <?php echo e(date('Y')); ?> Ferretería Nando. Todos los derechos reservados.
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH /mnt/disco_d/sexto_semestre/si1-ferreteria/si-ferreteria/resources/views/layouts/catalog.blade.php ENDPATH**/ ?>